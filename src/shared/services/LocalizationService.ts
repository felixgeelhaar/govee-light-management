...
export class LocalizationService {
  ...
  private loadTranslations(): void {
    ...
    this.translations.set("en", {
      ...
      Description:
        "Professional Govee smart light control with Stream Deck Plus dial support",
      Category: "Smart Home",
      ...
      Actions: {
        ...
        Brightness: {
          ...
          Tooltip:
            "Control brightness with dial rotation and touchscreen on Stream Deck+",
        },
        Color: {
          Name: "Color Control",
          Tooltip:
            "Control color with presets or hue adjustment on Stream Deck+",
        },
        Warmth: {
          Name: "Color Temperature",
          Tooltip:
            "Control color temperature (warmth) with dial rotation on Stream Deck+",
        },
      },
      ...
      Settings: {
        ...
        ApiKeyHelp:
          "Get your API key from the Govee Home app: Profile → Settings → Apply for API Key",
        ...
        AutoDiscoverHelp:
          "Automatically detect new Govee devices when they come online",
        ...
        ScreenReaderHelp:
          "Provides additional announcements for screen reader users",
      },
    ...
    this.translations.set("de", {
      ...
      Description:
        "Professionelle Govee Smart-Licht-Steuerung mit Stream Deck Plus Drehregler-Unterstützung",
      Category: "Smart Home",
      ...
      Actions: {
        Toggle: {
          ...
          Tooltip:
            "Einzelne Lichter ein/aus schalten mit Stream Deck+ Unterstützung",
        },
        Brightness: {
          Name: "Helligkeits-Steuerung",
          Tooltip:
            "Helligkeit mit Drehregler und Touchscreen am Stream Deck+ steuern",
        },
        Color: {
          Name: "Farb-Steuerung",
          Tooltip:
            "Farbe mit Voreinstellungen oder Farbton-Anpassung am Stream Deck+ steuern",
        },
        Warmth: {
          Name: "Farbtemperatur",
          Tooltip:
            "Farbtemperatur (Wärme) mit Drehregler am Stream Deck+ steuern",
        },
      },
      ...
      Settings: {
        ...
        ApiKeyHelp:
          "Holen Sie sich Ihren API-Schlüssel aus der Govee Home App: Profil → Einstellungen → API-Schlüssel beantragen",
        ...
        AutoDiscoverHelp:
          "Neue Govee-Geräte automatisch erkennen, wenn sie online kommen",
        InterfaceLanguage: "Oberflächensprache",
        HighContrast: "Verstärkter Kontrast-Modus",
        HighContrastHelp:
          "Erhöht den visuellen Kontrast für bessere Zugänglichkeit",
        ScreenReader: "Erweiterte Bildschirmleser-Unterstützung",
        ScreenReaderHelp:
          "Bietet zusätzliche Ansagen für Bildschirmleser-Benutzer",
      },
      ...
      Messages: {
        ...
        InvalidSettings:
          "Ungültige Einstellungen. Bitte überprüfen Sie Ihre Konfiguration",
        DeviceNotFound:
          "Gerät nicht gefunden. Es wurde möglicherweise entfernt",
