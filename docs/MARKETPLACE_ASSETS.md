...
| -------------------- | ------------------------------------------- | ----------------- | ---------- | ------------ |
| `1-hero.png`         | Hero — Stream Deck mockup + key pillars     | ✅ v2.7 revamp    | 1920×1080  | May 02, 2026 |
| `2-actions.png`      | Five hybrid actions + complementary keys    | ✅ v2.7 narrative | 1920×1080  | May 02, 2026 |
| `3-dials.png`        | Hybrid actions on Stream Deck+ dials        | ✅ v2.7 narrative | 1920×1080  | May 02, 2026 |
| `4-setup.png`        | 3-step setup (drop on key OR dial)          | ✅ v2.7 copy      | 1920×1080  | May 02, 2026 |
| `5-v21-features.png` | Recall — one key, any saved look (headline) | ✅ v2.7 feature   | 1920×1080  | May 02, 2026 |
| `6-v22-features.png` | Group state truth — three-state + banners   | ✅ v2.7 feature   | 1920×1080  | May 02, 2026 |

**Upload all 6 images to Elgato Marketplace** — minimum 3 required, all 6 tell the v2.7 story end-to-end. All six regenerated 2026-05-02 against the v2.7 narrative (collapse to hybrid actions + Recall + honest group state). Run `bash scripts/generate-gallery.sh` to refresh from HTML templates.
